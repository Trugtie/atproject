...
<section>
    <div class="container d-flex flex-column justify-content-around">
        ...
        <div class="text-center mb-5">
            <h1 class="title">UPDATE KHUYẾN MÃI</h1>
        </div>
                ...
                <form action="../controller/khuyenmaiController.php" method="POST" enctype="multipart/form-data">
                    <div class="row1">
                        <div class="col-sm-12" style="margin-left: 3rem;">
                            ...
                            <div class="pic" style="width: 290px; height: 237px; border: 1px solid;"><img name="hinh" id="hinh" style="min-width: 290px; max-height: 237px;" src="<?php echo "./" . $khuyenmai['hinh'] ?>" alt> </div>
                            ...
                            <input type="text" style="margin-top: 10px; font-size:20px; width: 200px; float:right" name="makm" value="<?php echo $khuyenmai['makm'] ?>" hidden><br>
                            <label style="font-size:20px;margin-top: 15px">Tên đợt khuyến mãi</label><br>
                            <input type="text" style="margin-top: 10px; font-size:20px; width: 100%" name="tenkm" value="<?php echo $khuyenmai['tenkm'] ?>"><br>
                            <label style="font-size:20px;margin-top: 15px">Mô tả</label><br>
                            <textarea style="margin-top: 10px; font-size:20px; width: 100%; height:135px" name="mota"> <?php echo $khuyenmai['mota'] ?></textarea><br>
                            <label style="font-size:20px;margin-top: 15px">Giá trị giảm</label><br>
                            <input type="text" style="margin-top: 10px; font-size:20px; width: 100%" name="giatrigiam" value="<?php echo $khuyenmai['giatrigiam'] ?>"><br>

                            <label style="font-size:20px;margin-top: 15px">Ngày bắt đầu</label><br>
                            <input type="date" style="margin-top: 10px; font-size:20px; width: 100%" name="ngaybd" value="<?php echo $khuyenmai['ngaybd']?>"><br>

                            <label style="font-size:20px;margin-top: 15px">Ngày kết thúc</label><br>
                            <input type="date" style="margin-top: 10px; font-size:20px; width:100%" name="ngaykt" value="<?php echo $khuyenmai['ngaykt'] ?>"><br>
                    ...
                    <div class="btn-add">
                        <button id="btn-add" type="submit" name="action" value="updateKhuyenmai" id="">UPDATE</button>
                    </div>
                </form>
            </div>
        </div>
