...
$statement = $pdo->prepare("insert into laptop(masp,tensp,mota,soluong,hinh,gia,loaisp,tinhtrang,trongluong,manhinh,ocung,vga,ram,cpu,pin,mausac,mahang,maloaimay)
    values(:masp,:tensp,:mota,:soluong,:hinh,:gia,:loaisp,:tinhtrang,:trongluong,:manhinh,:ocung,:vga,:ram,:cpu,:pin,:mausac,:mahang,:maloaimay)");
