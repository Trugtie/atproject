            ...
            <div class="row">
                    ...
                    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img id="img" src="<?php echo "../admin/view/" . $phukien['hinh'] ?>" alt="">
                            </div>
                ...
                <div class="col-sm-6  text_dp">
                    <h2 class="pro-d-title " id="title-color">
                        <?php echo $phukien['tensp']; ?>
                    </h2>
                    <div style="font-size: 16px;">
                        <b>Mô tả :</b>
                        <?php echo $phukien['mota']; ?>

                    </div>
                    <div class="product_meta ">
                        <span class="posted_in"> <strong>Hãng :</strong> <a rel="tag" href="#"><?php echo $phukien['tenhang']; ?></a>
                    </div>
                    <div class="m-bot15"> <strong>Giá : </strong><span class="pro-price"><?php echo  number_format($phukien['gia'], 0, ",", ".") . " VND" ?></span></div>
                    <div class="btnBuy">
                        <form action="../controller/cart.php" method="post">
                            <input type="hidden" name="masp" value="<?php echo  $phukien['masp'] ?>">
