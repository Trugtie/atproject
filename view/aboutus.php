    ...
    <div class="container">
        ...
        <div class="row about">
            <div class="col-6 d-flex flex-column justify-content-center">
                <h2 class="heading animate-top">Về chúng tôi</h2>
        ...
        <div class="row history">
            <div class="col-6 order-2 d-flex flex-column justify-content-center">
                <h2 class="heading animate-top">Lịch sử hình thành</h2>
                <p class="description animate-right">Atlaptop được thành lập vào năm 2020 bởi 2 founder Trugtie và AlarShere với mong muốn mang lại cho khách hàng những sản phẩm hiện đại và mạnh mẽ nhất.
                </p>
            </div>
