...
<section class="panel">
      ...
      <div class="row">
          ...
          <div class="col-sm-6  text_dp">
              <h2 class="pro-d-title" style="font-size: 20px;">
                  <a href="#" class="">
              ...
              <div class="btnBuy">
                  <button class="btn btn-danger text_dp" style="height: 40px;" type="button"><i class="fa fa-shopping-cart"></i> Thêm vào giỏ</button>
                  <button class="btn btn-warning text_dp" style="height: 40px;" type="button"><i class="fa fa-shopping-cart"></i> Mua ngay</button>
